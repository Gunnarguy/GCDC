...
**Action:** Always prefer `max_selections=N` on `st.multiselect` over manual validation logic for enforcing selection counts. Pair it with clear `placeholder` text (e.g., "Choose up to 4...").
